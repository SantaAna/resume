defmodule Resume.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Resume.Repo)
  ...
  """
  def valid_password?(%Resume.Accounts.User{hashed_password: hashed_password}, password)
