defmodule Resume.Accounts do
  ...
  alias Resume.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Resume.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Resume.Accounts.User.password_changeset/3` for a list of supported options.
